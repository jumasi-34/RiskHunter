...
*   **미래 감사 일정 배포 및 시딩 (Seeding Spec)**: 해커톤 시연 환경에서 미래 감사 수검 준비 대시보드가 풍부하게 가동되도록, 각 거점별 1~2개(특별 거점인 MP, JP, TP는 3~5개 이상 완벽 매핑) 총 28개의 고품격 미래 감사 일정이 오픈 상태(`"STATUS": "Open"`)로 파일 DB 최상단에 주입되어 있습니다. 
    *   **신규 추가된 미래 감사 일정 목록 (11개)**:
        ...
        | 공장 (PLANT) | 완성차 (OEM) | 감사 주제 (SUBJECT) | 예정 시작일 (START_DT) | 프로세스 (PROCESS) | 사전 예상 지적사항 (POINT_OUT_KO) |
        | :--- | :--- | :--- | :--- | :--- | :--- |
        | **DP** (대전) | Audi | 2026-Audi 대전공장 신규 친환경 타이어 공급사 실사 | 2026-11-20 | Curing | 가류 공정 가류 온도 및 압력 정밀 센서 분기별 점검 기록 SOP 누락 |
        | **KP** (금산) | Kia | 2026-기아자동차 금산공장 EV9 신제품 특별 품질 수검 | 2026-12-05 | Mixing | 배합 공정 고점도 고무 가공 온도 급상승 방지 긴급 인터록 밸브 작동 지연 우려 |
        | **HP** (강소) | Xiaomi | 2026-Xiaomi 강소공장 스마트 전기차 타이어 공급사 정기 평가 | 2026-11-05 | Building | 성형 공정 이너라이너 조인트 부분 레이저 거리 센서 교정 성적서 만료 |
        | **CP** (중경) | Changan | 2026-Changan 중경공장 품질 보증 정기 점검 | 2026-12-15 | Extrusion | 압출 공정 스크류 예열 장치 보조 전압 트랜스포머 점검 주기 미준수 |
        | **IP** (인도네시아) | Hyundai | 2026-현대자동차 인도네시아공장 아세안 시장용 타이어 특별 실사 | 2026-11-25 | Inspection | 검사 공정 타이어 밸런싱 시험기 마스터 고무 시편 보관 온도 기준 가이드 미준수 |
        | **MP** (헝가리) | Volvo | 2026-Volvo 헝가리공장 신규 플랫폼용 친환경 타이어 ESG 및 품질 정합성 심사 | 2026-12-01 | Logistics | 물류 창고 완제품 친환경 타이어 고온 다습 구역 공조 제어 설정 편차 관리 미흡 |
        | **MP** (헝가리) | Stellantis | 2027-Stellantis 헝가리공장 유럽 전략 차량 공급 품질 보증 수검 | 2027-01-15 | Calendaring | 캘린더링 공정 토핑 고무 두께 편차 자동 피드백 경보 신호 무음 처리 흔적 발견 |
        | **JP** (가흥) | Nissan | 2026-Nissan 가흥공장 글로벌 최고 공급망 품질 실사 | 2026-11-18 | Cutting | 재단 공정 바이어스 재단기 슬리터 각도 캘리브레이션 무단 생략 및 SOP 일탈 |
        | **JP** (가흥) | Toyota | 2027-Toyota 가흥공장 프리미엄 완성차 공급 정기 보증 감사 | 2027-02-10 | Bead | 비드 공정 에이프런 에지 성형 휠 고정 상태 주기 점검 미실시 |
        | **TP** (테네시) | Tesla | 2026-Tesla 테네시공장 기가팩토리 전용 타이어 스펙 특별 감사 | 2026-11-30 | Building | 성형 공정 벨트 드럼 흡착 압력 미세 리크 센서 교정 기준 이탈 조치 부재 |
        | **TP** (테네시) | Hyundai | 2027-현대자동차 테네시공장 메타플랜트 전용 타이어 양산 정합성 실사 | 2027-03-05 | Curing | 가류 공정 가류 블래더 수명 예측 계측 장치 알람 이력 점검 부재 |
