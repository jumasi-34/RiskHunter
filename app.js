...
=========================================================`;
  ...
  renderDashboard() {
      ...
      plantCriGrid.innerHTML = rankings.map((item, idx) => {
        ...
        return `
          <div class="card-solid" 
               style="height: 130px; box-sizing: border-box; padding: 14px 12px; background: rgba(30, 41, 59, 0.03); border: 1px solid var(--border-card); border-radius: 6px; display: flex; flex-direction: column; justify-content: space-between; gap: 8px; cursor: pointer; transition: all 0.2s ease-in-out; margin: 0; box-shadow: none;" 
    ...
    // ------------------------------------------------------------------------
    // [2], [3] 차트 시각화 영역 제거됨 (공장별 실시간 위험 점수 / 취약 공정별 리스크 누적 분포)
    // ------------------------------------------------------------------------
